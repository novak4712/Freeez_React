...
const Modal = () => {
    ...
    const modalItems = ['image-1', "image-2", "image-3", "image-4", 'image-5'];
    ...
    return (
        <div
            ...
            <ScrollTip currentPage={currentPage} length={modalItems.length} theme='light'/>
            ...
            <ReactPageScroller
                ...
                blockScrollDown={currentPage === modalItems.length - 1}
            >
                {modalItems.map((item, idx) => {
                    return <ModalItem item={item} key={`${item}-${idx}`}/>
                })}
