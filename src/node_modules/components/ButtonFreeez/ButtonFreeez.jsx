...
const ButtonFreeez = ({text, close, theme, width, align, url, type}) => {
    ...
    return (
        <React.Fragment>
            {(url) ? <ButtonLink text={text} close={close} themeButton={themeButton} width={width} align={align}
                                 url={url}/> :
                <Button text={text} close={close} themeButton={themeButton} width={width} align={align} type={type}/>}
        </React.Fragment>
    )
};
const Button = ({text, close, themeButton, width, align, type}) => {
...
const CloseButton = ({close}) => {
    const className = (close === 'Cross' ? styles.closeButtonPlus : styles.closeButtonCross);
