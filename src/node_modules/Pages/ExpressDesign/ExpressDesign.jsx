...
const ExpressDesign = () => {
    ...
    const addShoppingBag = (total) => {
        const {expressBag} = currentShoppingBagState;
        const currentTotal = []
        // eslint-disable-next-line array-callback-return
        total.map((item) => {
            if (!expressBag.includes(item.id)) {
                expressBag.push(item.id)
            }
        })
        dispatch({type: 'SET_EXPRESS_BAG', payload: [...expressBag, ...currentTotal]});
        setTotal([]);
        history.push("/shopping_bag");
    }
            ...
            <div className={styles.expressDesign}>
                ...
                <div className={`${styles.column} ${styles.onceColumn} ${styles.columnRight}`}>
                    <div className={`${styles.column} ${styles.totalColumn}`}>
                        ...
                        <div className={styles.buttonWrapper} onClick={() => addShoppingBag(total)}>
