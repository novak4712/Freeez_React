...
const MainPage = () =>{
    ...
    return <div className={`${currentThemeState.isLight ? styles.mainPageLight : styles.mainPageDark} ${styles.mainPage}`}>
        {currentThemeState.isLight ? <LightContent /> : <DarkContent />}
    </div>
};
const DarkContent = () => {
    return <svg width="1626" height="491" viewBox="0 0 1626 491" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M109 430L108.272 429.708L0 386.285L0.47258 385.84L81.7564 310L81.9224 310.699L109 430Z" fill="#DA2525"/>
        <path d="M81.9224 310.699L109 430L108.272 429.708L60.3625 386.717L81.9224 310.699Z" fill="#DD5050"/>
        <path d="M0 386.285L109 430L108.272 429.708L60.3625 386.717L0 386.285Z" fill="#AA0000"/>
        ...
        <path d="M1559.8 8.26458e-05L1559.58 1.82645L1526.94 273.417L1525.64 272.616L1304.53 134.536L1306.02 133.736L1559.8 8.26458e-05Z" fill="#DA2525"/>
        <path d="M1306.02 133.736L1559.8 5.01355e-05L1559.58 1.82643L1491.28 136.433L1306.02 133.736Z" fill="#DD5050"/>
        <path d="M1526.94 273.417L1559.8 6.4813e-05L1559.58 1.82644L1491.28 136.433L1526.94 273.417Z" fill="#AA0000"/>
